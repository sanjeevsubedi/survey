            ...
            } else
{
            ...
            var upload_file = function()
            {
                ...
                else if(true === settings.validate_file_size && $element[0].files[0].size > settings.valid_file_size) {
                    // Pass back to the user
                    settings.onComplete.apply($element, [{
                        status: false,
                        size: $element[0].files[0].size, 
                        message: 'The select file must be smaller than 2 Mb'
                    }, settings.params]);     
